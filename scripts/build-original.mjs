...
export function validateOriginal(output) {
  ...
  c.otherProjects.forEach(project => add(project.name, project.period, project.subtitle, project.description));
